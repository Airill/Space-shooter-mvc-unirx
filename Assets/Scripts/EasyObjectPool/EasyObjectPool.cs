...
namespace MarchingBytes {
	...
	class Pool {
		...
		//o(1)
		public GameObject NextAvailableObject(UnityEngine.Vector3 position, Quaternion rotation) {
			PoolObject po = null;
...
//				Debug.Log("Creating pool: " + currentPoolInfo.poolName);
		...
		*/
		public GameObject GetObjectFromPool(string poolName, UnityEngine.Vector3 position, Quaternion rotation) {
			GameObject result = null;
